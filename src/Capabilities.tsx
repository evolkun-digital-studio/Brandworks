...
const TITLE_CLASS = `${DISPLAY} text-[clamp(44px,12vw,64px)] font-bold leading-[0.96] tracking-[-0.04em] text-[#111] md:text-[clamp(46px,4.7vw,78px)]`;
      ...
      <ul className="m-0 mt-14 list-none space-y-11 p-0 md:col-span-6 md:col-start-7 md:mt-0 md:space-y-14">
        {services.map((service, i) => (
          ...
          >
            ...
            <span
              className={`${DISPLAY} mt-3 block text-[clamp(34px,10vw,50px)] leading-[1.1] tracking-[-0.035em] text-[#111] md:text-[clamp(40px,4.4vw,64px)]`}
            >
              {service.name}
            </span>
