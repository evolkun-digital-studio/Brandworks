...
const SceneCaption = forwardRef<HTMLDivElement, { project: VideoProject }>(
  ({ project }, ref) => {
    return (
      <div
        ref={ref}
...
export default function Videography() {
    ...
    () => {
      ...
      mm.add(
        ...
        (context) => {
          ...
          const firstFullFrame = "inset(0% 0% 0% 0% round 0px)";
          ...
          gsap.set([media0, media1, media2, media3], {
            scale: desktop ? 1.055 : 1.035,
            yPercent: 1.5,
            force3D: true,
          });

          gsap.set([line0, line1, line2, line3], {
            autoAlpha: 0,
            y: 14,
          });
          ...
          const tl = gsap.timeline({
            ...
            scrollTrigger: {
              trigger: section,
              start: "top top",
              end: () => `+=${window.innerHeight * (desktop ? 5.45 : 4.65)}`,
              pin: stage,
              ...
              onUpdate: (self) => {
                ...
                const nextIndex = p < 0.3 ? 0 : p < 0.48 ? 1 : p < 0.66 ? 2 : 3;
                ...
                setGalleryLive((current) =>
                  current === shouldPlayGallery ? current : shouldPlayGallery,
                );
              },
            },
          });
          ...
          return () => {
            if (masterTimelineRef.current === tl)
  ...
  const isLive = (index: number) => Math.abs(index - activeIndex) <= 1;
      ...
      <div ref={stageRef} className="relative h-svh w-full overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-x-[4vw] top-1/2 -translate-y-1/2 md:inset-x-[5vw]">
            <h2 id="videography-heading" className="sr-only">
              Cinemato graphy
            </h2>
        ...
        >
          ...
          <SceneCaption ref={line0Ref} project={VIDEO_PROJECTS[0]} />
        </div>
        ...
        >
          ...
          <SceneCaption ref={line1Ref} project={VIDEO_PROJECTS[1]} />
        </div>
        ...
        >
          ...
          <SceneCaption ref={line2Ref} project={VIDEO_PROJECTS[2]} />
        </div>
        ...
        >
          ...
          <SceneCaption ref={line3Ref} project={VIDEO_PROJECTS[3]} />
        </div>
        ...
        >
          <div
            ...
            className="absolute inset-0 will-change-transform"
          >
            <Film project={VIDEO_PROJECTS[0]} live={activeIndex === 3} />
          </div>
        ...
        >
          ...
          >
            <Icon
              icon={isCurrentVideoPlaying ? "lucide:pause" : "lucide:play"}
          ...
          <div className="flex h-12 shrink-0 items-center gap-1 rounded-[16px] border border-white/10 bg-black/55 p-1 backdrop-blur-xl sm:h-14 sm:gap-1.5 sm:rounded-[18px] max-[430px]:h-10 max-[430px]:gap-0.5 max-[430px]:rounded-[13px]">
            {VIDEO_PROJECTS.map((project, index) => (
              ...
              >
                ...
                />
                <span
                  className={`pointer-events-none absolute inset-0 transition-colors duration-300 ${activeIndex === index ? "bg-black/0" : "bg-black/25"}`}
                />
              </button>
            ))}
          </div>
          ...
          <div className="flex h-12 shrink-0 items-center gap-2.5 rounded-[16px] border border-white/10 bg-[rgba(42,28,23,0.72)] px-4 text-white shadow-[0_10px_34px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:h-14 sm:gap-3 sm:rounded-[18px] sm:px-5 max-[430px]:h-10 max-[430px]:gap-1.5 max-[430px]:rounded-[13px] max-[430px]:px-2.5">
            <span
              className="h-2 w-2 shrink-0 rounded-full bg-[#8f8a16] shadow-[0_0_10px_rgba(143,138,22,0.32)] max-[430px]:h-1.5 max-[430px]:w-1.5"
              aria-hidden="true"
            />
            <span className="font-primary text-[11px] font-medium tracking-[-0.01em] sm:text-[13px] max-[430px]:text-[9px]">
              30FPS
            </span>
            <span
              ref={timecodeRef}
              className="min-w-[68px] font-primary text-[11px] font-medium tabular-nums tracking-[0.02em] text-white/90 sm:min-w-[78px] sm:text-[13px] max-[430px]:min-w-[56px] max-[430px]:text-[9px]"
            >
              00:00:00
            </span>
          </div>
          ...
          >
            <div className="mb-7 flex items-end justify-between gap-8 pb-4 md:mb-9">
              <div>
                <p className="mt-2 font-primary text-[clamp(1.6rem,2.7vw,3rem)] font-medium leading-[0.98] tracking-[-0.04em]">
                  One idea.
                  <span className="text-black/38"> Different frames.</span>
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2.5 md:grid-cols-4 md:gap-3">
              {VIDEO_PROJECTS.map((project, index) => (
                ...
                >
                  <GalleryFilm project={project} live={galleryLive} />
                </div>
              ))}
            </div>
          </div>
        ...
        {/* PROGRESS — kept for GSAP, visually hidden */}
        {/* PROGRESS — kept for GSAP, visually hidden */}
        {/* PROGRESS — kept for GSAP, visually hidden */}
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-[90] h-px opacity-0">
          <div
            ref={progressRef}
            className="h-full w-full origin-left scale-x-0 bg-transparent"
          />
        </div>
      </div>
    </section>
